...
public class GatewayApiGroupNacosPublisher implements DynamicRulePublisher<List<ApiDefinitionEntity>> {
    ...
    private Converter<List<ApiDefinitionEntity>, String> converter = JSON::toJSONString;
    @Override
    public void publish(String app, List<ApiDefinitionEntity> rules) throws Exception {
        ...
        configService.publishConfig(app + NacosConfigUtil.GW_API_GROUP_DATA_ID_POSTFIX,
